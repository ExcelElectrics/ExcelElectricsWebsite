...
export function ContactHero() {
  ...
  return (
    <section className="electrics-hero-min-h-sm relative isolate scroll-mt-0 overflow-hidden bg-black">
      <Image
        src="/ExcelElectrics/services/access/access-hero.webp"
        alt="Excel Electrics engineer on site ready to help with your enquiry"
        fill
        priority
        sizes="100vw"
      ...
      >
        <div ref={contentRef} className="max-w-3xl space-y-5 md:space-y-6">
          ...
          >
            Send a quick message or email us - we&apos;ll reply as soon as we can, usually the same
            day. Fixed pricing across Essex, Suffolk, Cambridgeshire, Hertfordshire and London.
          </p>
          <div
