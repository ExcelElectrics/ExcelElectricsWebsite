  ...
  return (
    <section className="electrics-hero-min-h-sm relative isolate scroll-mt-0 overflow-hidden bg-black">
      <Image
        ...
        alt="Modern home lighting and electrics across the areas we cover"
        fill
        priority
        sizes="100vw"
      ...
      >
        <div ref={contentRef} className="max-w-3xl space-y-5 md:space-y-6">
          ...
          >
            Excel Electrics supports homes across Essex, Suffolk, Cambridgeshire, Hertfordshire,
            central London and Greater London. Tap the map or browse the full town lists below.
          </p>
          <div
